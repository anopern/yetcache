...
import com.yetcache.core.codec.CacheValueHolderReifier;
...
public class CoreConfiguration {
    @Bean
    public CacheValueHolderReifier cacheValueHolderReifier(JsonTypeConverter jsonTypeConverter) {
        return new CacheValueHolderReifier(jsonTypeConverter);
    }
