...
//    }
    ...
    protected void preventCachePenetration(String key) {
        E emptyPlaceholderObject = createEmptyPlaceholder();
        RedisSafeUtils.safeSet(key, emptyPlaceholderObject, (k, v)
