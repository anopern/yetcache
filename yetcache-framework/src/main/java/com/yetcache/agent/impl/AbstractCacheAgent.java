...
import com.yetcache.agent.ICacheAgent;
import com.yetcache.event.CacheEvent;
import com.yetcache.properties.BaseCacheAgentProperties;
import com.yetcache.utils.RabbitMQUtils;
import com.yetcache.utils.SpringContextProvider;
import com.yetcache.utils.TenantIdUtils;
...
public abstract class AbstractCacheAgent<E> implements ICacheAgent, ResolvableTypeProvider {
    ...
    protected E createEmptyPlaceholder() {
