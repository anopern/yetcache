...
//import com.yetcache.core.cache.command.hash.HashCacheBatchGetCommand;
...
//            return BaseCacheResult.batchHit(agentScope.getCacheAgentName(), resultValueHolderMap, hitLevelInfo);
//        } catch (Exception e) {
//            log.warn("batchGet failed. key={}, fields={}, error={}", bizKey, bizFields, e.getMessage(), e);
//            return BaseCacheResult.fail(agentScope.getCacheAgentName(), e);
//        }
//    }
//}
